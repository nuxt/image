...
import ipx from '@nuxt/image/runtime/providers/ipx'
import none from '@nuxt/image/runtime/providers/none'
import weserv from '@nuxt/image/runtime/providers/weserv'
import aliyun from '@nuxt/image/runtime/providers/aliyun'
import awsAmplify from '@nuxt/image/runtime/providers/awsAmplify'
import cloudflare from '@nuxt/image/runtime/providers/cloudflare'
import cloudinary from '@nuxt/image/runtime/providers/cloudinary'
import twicpics from '@nuxt/image/runtime/providers/twicpics'
import fastly from '@nuxt/image/runtime/providers/fastly'
import prepr from '@nuxt/image/runtime/providers/prepr'
import glide from '@nuxt/image/runtime/providers/glide'
import imgix from '@nuxt/image/runtime/providers/imgix'
import gumlet from '@nuxt/image/runtime/providers/gumlet'
import imageengine from '@nuxt/image/runtime/providers/imageengine'
import unsplash from '@nuxt/image/runtime/providers/unsplash'
import imagekit from '@nuxt/image/runtime/providers/imagekit'
import netlifyImageCdn from '@nuxt/image/runtime/providers/netlifyImageCdn'
import netlifyLargeMedia from '@nuxt/image/runtime/providers/netlifyLargeMedia'
import prismic from '@nuxt/image/runtime/providers/prismic'
import sanity from '@nuxt/image/runtime/providers/sanity'
import shopify from '@nuxt/image/runtime/providers/shopify'
import contentful from '@nuxt/image/runtime/providers/contentful'
import cloudimage from '@nuxt/image/runtime/providers/cloudimage'
import storyblok from '@nuxt/image/runtime/providers/storyblok'
import strapi from '@nuxt/image/runtime/providers/strapi'
import strapi5 from '@nuxt/image/runtime/providers/strapi5'
import vercel from '@nuxt/image/runtime/providers/vercel'
import wagtail from '@nuxt/image/runtime/providers/wagtail'
import uploadcare from '@nuxt/image/runtime/providers/uploadcare'
import sirv from '@nuxt/image/runtime/providers/sirv'
import hygraph from '@nuxt/image/runtime/providers/hygraph'

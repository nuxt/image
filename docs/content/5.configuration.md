...
Specify a value to work with DevicePixelRation > 1 (these are devices with Retina display and others). You must specify for which DevicePixelRation values you want to adapt images.

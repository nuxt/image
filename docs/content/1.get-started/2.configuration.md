...
You can update all the above properties at runtime by adding your configs as `runtimeConfig.public.ipx` key in `nuxt.config.ts`.
This plugin will merge your injected variables with the module configs.

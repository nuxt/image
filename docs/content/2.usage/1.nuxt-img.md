...
This is a [native](https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/alt) global attribute that specifies an alternate text for an image, if the image cannot be displayed.

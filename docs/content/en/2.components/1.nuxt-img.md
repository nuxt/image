...
In addition to standard modifiers, every provider can have their own modifiers. This prop being dependant of the provider, please refer to your provider's documentation to know what modifiers can be used.

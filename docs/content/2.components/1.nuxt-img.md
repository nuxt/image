...
::alert{type="info"}
With [default provider](/getting-started/providers#default-provider), you should put `/nuxt-icon.png` inside `public/` directory for Nuxt3 and in `static/` for Nuxt2 to make the above example work.
::

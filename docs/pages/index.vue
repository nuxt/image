    ...
    <UContainer>
      ...
      <div class="flex items-center justify-between text-gray-400 gap-4 md:gap-8 mt-4 md:mt-10">
        ...
        <NuxtImg
          ...
          alt="Sephora"
          class="hidden md:inline-block md:h-6"
        />
        <NuxtImg
          width="205"
          height="28"
        ...
        <NuxtImg
          ...
          src="/brands/emma.svg"
          alt="Emma"
          class="hidden md:inline-block md:h-7"
        />
      </div>
    </UContainer>
    <ULandingSection>
      ...
      <UPageGrid>
        ...
        >
          <template #description>
            Leverage <code>&lt;nuxt-img&gt;</code> and <code>&lt;nuxt-picture&gt;</code> drop-in replacement for the
            native <code>&lt;img&gt;</code> and <code>&lt;picture&gt;</code> elements.
          </template>
        </ULandingCard>
        <ULandingCard
          to="/providers/ipx"
        ...
        <ULandingCard
          ...
          title="20+ Providers Supported"
          icon="i-ph-plug-duotone"
          description="Choose over 20 image providers to optimize your images, no vendor lock-in."
        />
        <ULandingCard
          to="/usage/nuxt-img#sizes"
          title="Responsive Ready"
          icon="i-ph-frame-corners"
          description="Nuxt Image dynamically generates responsive sizes. Your visuals adapt effortlessly to every screen size, offering a seamless user experience."
        />
        <ULandingCard
          to="/usage/nuxt-img#format"
          title="Future-Proof Formats"
          icon="i-ph-magic-wand-duotone"
          description="Embrace the future of visual optimization with support for modern formats like webp and avif."
        />
        <ULandingCard
          to="/get-started/installation"
          title="Streamlined Performance"
          icon="i-ph-rocket-launch-duotone"
          description="Deliver visually stunning content with lightning-fast load times, keeping your audience engaged and delighted."
        />
      </UPageGrid>
    </ULandingSection>

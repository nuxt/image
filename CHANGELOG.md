...
### [0.7.0](https://github.com/nuxt/image/compare/v0.6.1...v0.7.0) (2022-02-03)

### Features

- add `mobileFirst` property to config in order to have a mobile-first strategy rather than the default desktop-first ([#360](https://github.com/nuxt/image/issues/360))
